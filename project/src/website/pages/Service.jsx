                                    ...
                                    <>
                                        <div className="service-item position-relative">
                                            ...
                                            <div className="service-text text-center">
                                                <h4 className="text-white font-weight-medium px-3">{value.title}</h4>
                                                <p className="text-white px-3 mb-3">Elitr labore sit dolor erat est lorem diam sea ipsum diam dolor duo
                                                    sit ipsum</p>
                                                <div className="w-100 bg-white text-center p-4">
                                                    <a className="btn btn-primary" href = "javaScript:void(0)" onClick={() =>redirect('/view_services/' + (value.id))}>View Services</a>
                                                </div>
                                            </div>
                                        </div>
                                    </>
                            ...
                            <div className="p-5 my-5" style={{ background: 'rgba(33, 30, 28, 0.7)' }}>
                                ...
                                <form>
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="col-sm-6">
                                            <button className="btn btn-primary btn-block" type="submit" style={{ height: 47 }}>Make
                                                Appointment</button>
                                        </div>
                                    </div>
                                </form>
                            ...
                            <div className="col-lg-6">
                                ...
                                <div className="owl-carousel testimonial-carousel">
                                    <div className="position-relative">
                                        ...
                                        <p className="m-0">Aliquyam sed elitr elitr erat sed diam ipsum eirmod eos lorem nonumy. Tempor
