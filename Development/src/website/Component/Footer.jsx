                ...
                <div className="row">
                  <div className="col-sm-6 mb-5">
                    ...
                    <div className="d-flex flex-column justify-content-start">
                      <NavLink className="text-white-50 mb-2" to="/"><i className="fa fa-angle-right mr-2" />Home</NavLink>
                      <NavLink className="text-white-50 mb-2" to="/about"><i className="fa fa-angle-right mr-2" />About Us</NavLink>
                      <NavLink className="text-white-50 mb-2" to="/service"><i className="fa fa-angle-right mr-2" />Our Services</NavLink>
                      <NavLink className="text-white-50 mb-2" to="/price"><i className="fa fa-angle-right mr-2" />Pricing Plan</NavLink>
                      <NavLink className="text-white-50" to="/contact"><i className="fa fa-angle-right mr-2" />Contact Us</NavLink>
                    </div>
                  </div>
                  <div className="col-sm-6 mb-5">
